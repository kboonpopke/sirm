                    ...
                    <div class="card-body">
                        <form action="pbs-code.php" method="POST">
                            ...
                            <div class="row g-1">
                                ...
                                <div class="col">
                                    <label>Unit</label>
                                    <select name="pbs_unit_i" class="form-control">
                            ...
                            <div class="row g-1 mb-3">
                                ...
                                <div class="col">
                                    <label>Unit</label>                                    
                                    <select name="pbs_uniti_r" class="form-control">
                                    <option value="pcs.">pcs.</option>
                                    <option value="kg.">kg.</option>
                                    <option value="spool.">spool.</option>
                                    <!-- เพิ่มตัวเลือกเพิ่มเติมตามที่คุณต้องการ -->
                            ...
                            <div class="mb-3">
                                <label for="pbs_status">Status</label>
                                <select name="pbs_status" class="form-control">                                    

                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col-9">
                                ...
                                <?php
                    $query = "SELECT SUM(pbs_quantity_r) as total_quantity FROM pbs WHERE pbs_status = 'QC Passed'";
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col-9">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Remaining</div>
                                <?php
                            $query = "SELECT SUM(pbs_quantity_r) as total_quantity1 FROM pbs WHERE pbs_status = 'Returned'";
                            $query_run = mysqli_query($con, $query);
                            if ($query_run) {
                                $row = mysqli_fetch_assoc($query_run);
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col-9">
                                ...
                                <?php
                            $query = "SELECT SUM(pbs_quantity_r) as total_quantity2 FROM pbs WHERE pbs_status = 'Waiting for Destroy'";
                            $query_run = mysqli_query($con, $query);
                            if ($query_run) {
                                $row = mysqli_fetch_assoc($query_run);
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col-9">
                                ...
                                <?php
                            $query = "SELECT SUM(pbs_quantity_r) as total_quantity3 FROM pbs WHERE pbs_status = 'Waiting for Return'";
                            $query_run = mysqli_query($con, $query);
                            if ($query_run) {
                                $row = mysqli_fetch_assoc($query_run);
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col-9">
                                ...
                                <?php
                            $query = "SELECT SUM(pbs_quantity_r) as total_quantity4 FROM pbs WHERE pbs_status = 'Waiting for Inspection'";
                            $query_run = mysqli_query($con, $query);
                            if ($query_run) {
                                $row = mysqli_fetch_assoc($query_run);
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col-9">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Total</div>
                                <?php
    $query = "SELECT SUM(pbs_quantity_r) as total_quantity FROM pbs";
    $query_run = mysqli_query($con, $query);
    if ($query_run) {
        $row = mysqli_fetch_assoc($query_run);
        $total_quantity = $row['total_quantity'];
                        ...
                        <tbody>
                            <?php 
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        ...
                                        {
                                            ?>
                            <tr <?php if ($pbs['pbs_status'] == 'Waiting for Inspection') echo 'class="Inspection"'; ?>
                                <?php if ($pbs['pbs_status'] == 'Waiting for Destroy') echo 'class="Destroy"'; ?>
                                <?php if ($pbs['pbs_status'] == 'QC Passed') echo 'class="Passed"'; ?>
                                <?php if ($pbs['pbs_status'] == 'Returned') echo 'class="Returned"'; ?>
                                <?php if ($pbs['pbs_status'] == 'Waiting for Return') echo 'class="Return"'; ?>
                                ...
                                <td><?= $pbs['pbs_po']; ?></td>
                                <td><?= $pbs['pbs_icode']; ?></td>
                                <td><?= date('d-m-Y', strtotime($pbs['pbs_md'])); ?></td>
                                <td><?= date('d-m-Y', strtotime($pbs['pbs_rd'])); ?></td>
                                <td><?= $pbs['pbs_lotrb']; ?></td>
